...
const EditProfileDialog: React.FC<EditProfileDialogProps> = ({ userDetails, userId, setUserDetails }) => {
                    ...
                    <form onSubmit={handleSubmit} className='overflow-y-auto'>
                        <div className="grid gap-4 p-6">
                            <div className="flex flex-col justify-between gap-2">
                                ...
                                <Input id="name" onChange={changeEventHandler} value={profileForm.fullname} name="fullname" className="col-span-3" placeholder="Full name" />
                                {errors.fullname && (
