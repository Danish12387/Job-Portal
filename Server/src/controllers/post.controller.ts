...
export const createPost: RequestHandler = async (req, res): Promise<any> => {
    try {
...
export const getAllPost: RequestHandler = async (req, res): Promise<any> => {
    try {
...
export const likePostHandler: RequestHandler = async (req, res): Promise<any> => {
    try {
        const userId = req.id;
